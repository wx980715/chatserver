...
int main(int argc, char **argv)
{
    if (argc < 3)
    {
        cerr << "command invalid! example: ./ChatClient 192.168.8.129 22" << endl;
        exit(-1);
    }
...
void creategroup(int cliendfd, string str)
{
    int idx = str.find(":");
    if (idx == -1)
    {
        cerr << "creategroup msg invalid!" << endl;
        return;
    }
...
void addgroup(int cliendfd, string str)
{
...
void groupchat(int cliendfd, string str)
{
    int idx = str.find(":");
    if (idx == -1)
    {
        cerr << "groupchat msg invalid!" << endl;
        return;
    }
...
// "loginout" command handler
void loginout(int cliendfd, string str)
{
    json js;
